...
$query1 = "SELECT MAX(RIGHT(kode, 4)) AS max_kode FROM cprod23";
...
$kode_otomatis = "CWK23" . $kode_barang;
?>
...
<head>
  ...
  <title>CORRECTIVE HF WELDING KW-2500 T</title>
  ...
  <div class="container-fluid" style="height: 100%">
    <div class="row text-center align-items-center text-bg-dark mt-3">
      <div class="col-12" style="height: 20vh; margin-top: 30px">
        <h1 class="mt-5">CORRECTIVE PRODUKSI 2.3</h1>
      </div>
    </div>
    <div class="container-fluid px-4">
      <h2 class="mt-4">CORRECTIVE HF WELDING KW-2500 T</h2>
                ...
                <thead class="table-light">
                  <tr>
                    ...
                    <tbody>
                      ...
                      $query = 'SELECT * FROM cprod23 ORDER BY RIGHT(kode, 4) DESC';
                      ...
                      if (isset($_GET['Filter'])) {
                        ...
                        $tampil = mysqli_query($conn, "SELECT * FROM cprod23 WHERE tanggal BETWEEN '" . $tglawal . "' AND '" . $tglakhir . "'");
