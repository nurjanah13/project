...
$query = "SELECT MAX(RIGHT(kode, 4)) AS max_kode FROM wcblank";
...
$kode_otomatis = "WBK21" . $kode_barang;
?>
    ...
    <div class="container-fluid" style="height: 100%">             
      <div class="row text-center align-items-center text-bg-dark mt-3">
         <div class="col-12" style="height: 20vh; margin-top: 30px">
           <h1 class="mt-5">WEEKLY CHECK BLANKING</h1>              
         </div>            
      </div>
      <!-- form -->
        ...
        <form method="post" name="form-user" action="prosesp21.php" autocomplete="off" class="row g-3">
          ...
          <table class="table table-light">
            ...
            <tbody>
              ...
              <tr>
                <th>Silinder Hidrolik</th>
                <td>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Baik"  name="silinder">
                    <label class="form-check-label">
                     Baik 
                    </label>
                  </div>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Tidak Baik" name="silinder">
                    <label class="form-check-label">
                    Tidak Baik 
                    </label>              
                  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Baik"  name="oli">
                    <label class="form-check-label">
                     Baik 
                    </label>
                  </div>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Tidak Baik" name="oli">
                    <label class="form-check-label">
                    Tidak Baik 
                    </label>              
                  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Baik"  name="slider">
                    <label class="form-check-label">
                     Baik 
                    </label>
                  </div>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Tidak Baik" name="slider">
                    <label class="form-check-label">
                    Tidak Baik 
                    </label>              
                  </div>
          ...
          <div class="mt-4 mb-2" >
              <a href="/engineer/ProductionEngineering/produksi21/" class="btn btn-secondary btn-sm"><i class="bi bi-arrow-left"></i></a> 
          </div>  
   </div>    
   </div>        
