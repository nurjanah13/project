...
$query = "SELECT MAX(RIGHT(kode, 4)) AS max_kode FROM wcwelhf";
...
$kode_otomatis = "WWH23" . $kode_barang;
?>
...
<body>
    ...
    <div class="container-fluid" style="height: 100%">             
      <div class="row text-center align-items-center text-bg-dark mt-3">
         <div class="col-12" style="height: 20vh; margin-top: 30px">
           <h1 class="mt-5">WEEKLY CHECK MESIN HF WELDING HF 4500</h1>              
         </div>            
      </div>
      <!-- form -->
    <div style="margin: 30px;">
        <form method="post" name="form-user" action="prosesp23.php" autocomplete="off" class="row g-3">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Tidak Baik (Bocor)" name="selang">
                    <label class="form-check-label">
                    Tidak Baik (Bocor)
                    </label>              
                  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Baik"  name="plate">
                    <label class="form-check-label">
                     Baik 
                    </label>
                  </div>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Tidak Baik" name="plate">
                    <label class="form-check-label">
                    Tidak Baik 
                    </label>              
                  </div>
              ...
              <tr>
                <th>Oscilation Triode</th>
                <td>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Baik"  name="oscilation">
                    <label class="form-check-label">
                     Baik 
                    </label>
                  </div>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Tidak Baik" name="oscilation">
                    <label class="form-check-label">
                    Tidak Baik 
                    </label>              
                  </div>
          ...
          <div class="mt-4 mb-2" >
              <a href="/engineer/ProductionEngineering/produksi21/weldinghf" class="btn btn-secondary btn-sm"><i class="bi bi-arrow-left"></i></a> 
          </div>  
   </div>    
   </div>        
