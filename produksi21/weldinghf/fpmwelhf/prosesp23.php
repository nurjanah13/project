...
if(isset($_POST["submit"])){
    ...
    $query = "INSERT INTO fpmwelhf VALUES('$tanggal','$kode','$no_welhf','$silinder','$solenoid','$selang','$fit_speed',' $regulator','$angin','$volt','$ampere','$switch','$slctr_heater','$timer','$lampu',' $counter','$slctr_current','$baut','$screw','$pedal','$pegas','$var_condenser','$fix_condenser','$fswitch','$arc_supressor',$plate','$body','$traffo','$mcb','$relay','$main_switch','$heater','$vregulator','$oscilation','$catatan')";
