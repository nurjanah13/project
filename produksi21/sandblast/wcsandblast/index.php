...
$query = "SELECT MAX(RIGHT(kode, 4)) AS max_kode FROM wcsandblast";
...
$kode_otomatis = "WSB21" . $kode_barang;
?>
    ...
    <div class="container-fluid" style="height: 100%">             
      <div class="row text-center align-items-center text-bg-dark mt-3">
         <div class="col-12" style="height: 20vh; margin-top: 30px">
           <h1 class="mt-5">WEEKLY CHECK SAND BLASTING</h1>              
         </div>            
      </div>
      <!-- form -->
          ...
          <table class="table table-light">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <div class="form-check mt-2">
                      <input class="form-check-input" type="checkbox" value="Berfungsi" name="valve">
                      <label class="form-check-label">
                        Berfungsi
                      </label>
                  </div>
                  <div class="form-check mt-2"> 
                      <input class="form-check-input" type="checkbox" value="Tidak Berfungsi" name="valve">
                      <label class="form-check-label">
                        Tidak Berfungsi
                      </label>              
                  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Baik"  name="selang_flux">
                    <label class="form-check-label">
                     Baik 
                    </label>
                  </div>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Tidak Baik" name="selang_flux">
                    <label class="form-check-label">
                    Tidak Baik 
                    </label>              
                  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Baik"  name="selang_angin">
                    <label class="form-check-label">
                     Baik 
                    </label>
                  </div>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Tidak Baik" name="selang_angin">
                    <label class="form-check-label">
                    Tidak Baik 
                    </label>              
                  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Baik"  name="nozzle">
                    <label class="form-check-label">
                     Baik 
                    </label>
                  </div>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Tidak Baik" name="nozzle">
                    <label class="form-check-label">
                    Tidak Baik 
                    </label>              
                  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Baik"  name="siklon">
                    <label class="form-check-label">
                     Baik 
                    </label>
                  </div>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Tidak Baik" name="siklon">
                    <label class="form-check-label">
                    Tidak Baik 
                    </label>              
                  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Baik"  name="pedal">
                    <label class="form-check-label">
                     Baik 
                    </label>
                  </div>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Tidak Baik" name="pedal">
                    <label class="form-check-label">
                    Tidak Baik 
                    </label>              
                  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Baik"  name="hisapan">
                    <label class="form-check-label">
                     Baik 
                    </label>
                  </div>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Tidak Baik" name="hisapan">
                    <label class="form-check-label">
                    Tidak Baik 
                    </label>              
                  </div>
