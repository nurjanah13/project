...
$query = "SELECT MAX(RIGHT(kode, 4)) AS max_kode FROM dcsbrush";
    ...
    <div class="container-fluid" style="height: 100%">             
      <div class="row text-center align-items-center text-bg-dark mt-3">
         <div class="col-12" style="height: 20vh; margin-top: 30px">
           <h1 class="mt-5">DAILY CHECK SCOT BRUSH</h1>              
         </div>            
      </div>
      <!-- form -->
          ...
          <table class="table table-light">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Baik"  name="vbelt">
                    <label class="form-check-label">
                     Baik 
                    </label>
                  </div>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Tidak Baik" name="vbelt">
                    <label class="form-check-label">
                    Tidak Baik 
                    </label>              
                  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Baik"  name="pulley">
                    <label class="form-check-label">
                     Baik 
                    </label>
                  </div>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Tidak Baik" name="pulley">
                    <label class="form-check-label">
                    Tidak Baik 
                    </label>              
                  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Baik"  name="matabrush">
                    <label class="form-check-label">
                     Baik 
                    </label>
                  </div>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Tidak Baik" name="matabrush">
                    <label class="form-check-label">
                    Tidak Baik 
                    </label>              
                  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Baik"  name="shaft">
                    <label class="form-check-label">
                     Baik 
                    </label>
                  </div>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Tidak Baik" name="shaft">
                    <label class="form-check-label">
                    Tidak Baik 
                    </label>              
                  </div>
              ...
              <tr>
                <th>Kabel Power Motor</th>
                <td>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Baik"  name="cbl_pwr_mtr">
                    <label class="form-check-label">
                     Baik 
                    </label>
                  </div>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Tidak Baik" name="cbl_pwr_mtr">
                    <label class="form-check-label">
                    Tidak Baik 
                    </label>              
                  </div>
              ...
              <tr>
                <th>Kabel Power Utama</th>
                <td>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Baik"  name="cbl_pwr_utama">
                    <label class="form-check-label">
                     Baik 
                    </label>
                  </div>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Tidak Baik" name="cbl_pwr_utama">
                    <label class="form-check-label">
                    Tidak Baik 
                    </label>              
                  </div>
