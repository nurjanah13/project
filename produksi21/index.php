      ...
      <div class="row mt-5">       
        <div class="col-sm-3 mt-3 mb-sm-0">          
          <div class="card align-items-center">
            <img src="https://cdn.pixabay.com/photo/2012/04/01/19/40/wrench-24261__340.png" style="height: 150px; width: 150px"/>
            <div class="card-body text-center">
              <h3 class="card-title"></h3>              
              <a href="blanking" class="btn btn-primary"><h5>Blanking</h5></a>
            </div>
          </div>
        </div>
       <!-- <div class="col-sm-3 mt-3 mb-sm-0">          
         <div class="card align-items-center">
           ...
           <div class="card-body text-center">
             <h3 class="card-title"></h3>              
             <a href="etching" class="btn btn-primary"><h5>Etching</h5></a>
           </div>
         </div>
       </div>
       <div class="col-sm-3 mt-3 mb-sm-0">          
        <div class="card align-items-center">
          ...
          <div class="card-body text-center">
            <h3 class="card-title"></h3>              
            <a href="laser" class="btn btn-primary container-fluid"><h5>Laser Marking</h5></a>
          </div>
        </div>
      </div> 
      <div class="col-sm-3 mt-3 mb-sm-0">          
        <div class="card align-items-center">
          ...
          <div class="card-body text-center">
            <h3 class="card-title"></h3>              
            <a href="Gerinda" class="btn btn-primary container-fluid"><h5>Gerinda Amplas</h5></a>
          </div>
        </div>
      </div>         -->
      <div class="col-sm-3 mt-3 mb-sm-0">          
        <div class="card align-items-center">
          ...
          <div class="card-body text-center">
            <h3 class="card-title"></h3>              
            <a href="sandblast" class="btn btn-primary container-fluid"><h5>Sand Blasting</h5></a>
          </div>
        </div>
      </div>  
      <div class="col-sm-3 mt-3 mb-sm-0">          
        <div class="card align-items-center">
          ...
          <div class="card-body text-center">
            <h3 class="card-title"></h3>              
            <a href="scotBrush" class="btn btn-primary container-fluid"><h5>Scot Brush</h5></a>
          </div>
        </div>
      </div> 
      <!-- <div class="col-sm-3 mt-3 mb-sm-0">          
        <div class="card align-items-center">
          ...
          <div class="card-body text-center">
            <h3 class="card-title"></h3>              
            <a href="sharpening" class="btn btn-primary container-fluid"><h5>Sharpening Grind</h5></a>
          </div>
        </div>
      </div>    -->
      <div class="col-sm-3 mt-3 mb-sm-0">          
        <div class="card align-items-center">
          ...
          <div class="card-body text-center">
            <h3 class="card-title"></h3>              
            <a href="ultrasonic" class="btn btn-primary container-fluid"><h5>Ultrasonic Cleaner</h5></a>
          </div>
        </div>
      </div>
     </div>    
