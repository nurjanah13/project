...
$query = "SELECT MAX(RIGHT(kode, 4)) AS max_kode FROM dcblank";
...
$kode_otomatis = "DBK21" . $kode_barang;
?>
    ...
    <div class="container-fluid" style="height: 100%">             
      <div class="row text-center align-items-center text-bg-dark mt-3">
         <div class="col-12" style="height: 20vh; margin-top: 30px">
           <h1 class="mt-5">DAILY CHECK BLANKING</h1>              
         </div>            
      </div>
      <!-- form -->
    <div style="margin: 30px;">
        <form method="post" name="form-user" action="prosesp21.php" autocomplete="off" class="row g-3">
          ...
          <div class="col-12 mt-3">
            <label for="no_blank" class="form-label"><h6>Nomor mesin</h6></label>
            <select id="no_blank" name="no_blank"class="form-select" required>
              <option selected>pilih nomor mesin</option>
              <option value="Blanking 1">Blanking 1</option>
            </select>
          </div>   
          <table class="table table-light">
            ...
            <tbody>
              ...
              <tr>
                <th>Permukaan Penekan</th>
                <td>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Baik"  name="penekan">
                    <label class="form-check-label">
                     Baik 
                    </label>
                  </div>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Tidak Baik" name="penekan">
                    <label class="form-check-label">
                    Tidak Baik 
                    </label>              
                  </div>
