...
$query = "SELECT MAX(RIGHT(kode, 4)) AS max_kode FROM wcsbrush";
    ...
    <div class="container-fluid" style="height: 100%">             
      <div class="row text-center align-items-center text-bg-dark mt-3">
         <div class="col-12" style="height: 20vh; margin-top: 30px">
           <h1 class="mt-5">WEEKLY CHECK SCOT BRUSH</h1>              
         </div>            
      </div>
      <!-- form -->
          ...
          <table class="table table-light">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Baik"  name="motor">
                    <label class="form-check-label">
                     Baik 
                    </label>
                  </div>
                  <div class="form-check mt-2"> 
                    <input class="form-check-input" type="checkbox" value="Tidak Baik" name="motor">
                    <label class="form-check-label">
                    Tidak Baik 
                    </label>              
                  </div>
              ...
              <tr>
                ...
                <td>
                  <div class="form-check mt-2">
                      <input class="form-check-input" type="checkbox" value="Baik" name="level">
                      <label class="form-check-label">
                        Baik
                      </label>
                  </div>
                  <div class="form-check mt-2"> 
                      <input class="form-check-input" type="checkbox" value="Tidak Baik" name="level">
                      <label class="form-check-label">
                        Tidak Baik
                      </label>              
                  </div>
