    ...
    <div class="container-fluid" style="height: 100%">             
      <div class="row text-center align-items-center text-bg-dark mt-3">
         <div class="col-12" style="height: 20vh; margin: 20px">
           <h1 class="mt-5">MESIN HF WELDING KW-2500 T</h1>              
         </div>            
      </div>
       ...
       <div class="col-sm-3 mb-3 mb-sm-0">          
         <div class="card align-items-center">
           ...
           <div class="card-body text-center">
             ...
             <a href="dcwelhf" class="btn btn-primary">MASUK</a>
           </div>
         </div>
       </div>
       <div class="col-sm-3">
         <div class="card align-items-center">
           ...
           <div class="card-body text-center">
             ...
             <a href="wcwelhf" class="btn btn-primary">MASUK</a>
           </div>
         </div>
       </div>
       <div class="col-sm-3">
        <div class="card align-items-center">
          ...
          <div class="card-body text-center">
            ...
            <a href="fpmwelhf" class="btn btn-primary">MASUK</a>
          </div>
        </div>
      </div>
      <div class="col-sm-3">
       <div class="card align-items-center">
         ...
         <div class="card-body text-center">
           ...
           <a href="cprod23" class="btn btn-primary">MASUK</a>
         </div>
       </div>
     </div>
     </div>    
